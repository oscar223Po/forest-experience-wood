 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".example__slider")) new swiper_core_Swiper(".example__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".gallery-module__thumbs")) {
                const thumbsSwiper = new swiper_core_Swiper(".gallery-module__thumbs", {
                    modules: [ Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new swiper_core_Swiper(".gallery-module__slider", {
            ...
            if (headCatalogItems !== null) {
                checkboxes.forEach((function(checkbox) {
                    checkbox.addEventListener("change", (function() {
                        ...
                        } else if (itemDiv) headCatalogItems.removeChild(itemDiv);
                    }));
                }));
